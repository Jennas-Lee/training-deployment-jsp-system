...
# Disable firewalld
echo -e "${YELLOW}Stop firewalld${NC}"
...
# Disable iptables
echo -e "${YELLOW}Stop iptables${NC}"
...
# Install yum-utils
echo -e "${YELLOW}Install yum utils${NC}"
...
echo -e "${YELLOW}Add docker package repository${NC}"
yum-config-manager \
  --add-repo \
